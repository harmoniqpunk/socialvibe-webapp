...
export const trendingPostsData = [
  ...
  },
  {
    ...
    name: 'Elon Musk',
    author: '@elonmusk',
    content: 'Tesla Cybertruck production ramping up faster than expected. Manufacturing at scale!',
    engagement: 11200,
    likes: 6800,
    retweets: 2400,
    replies: 1600,
  ...
  },
  {
    ...
    name: 'Sam Altman',
    author: '@sama',
    content: 'GPT-5 will fundamentally change how we interact with computers. The future is closer than you think.',
    engagement: 8900,
    likes: 5100,
    retweets: 1900,
    replies: 1300,
  ...
  },
  {
    ...
    name: 'Naval Ravikant',
    author: '@naval',
    content: 'Meditation is not about stopping thoughts. It\'s about observing them without attachment.',
    engagement: 6400,
    likes: 3800,
    retweets: 1500,
    replies: 800,
  ...
  },
  {
    ...
    name: 'Marc Andreessen',
    author: '@pmarca',
    content: 'The next billion-dollar startup will be built by someone reading this tweet right now.',
    engagement: 5600,
    likes: 3300,
    retweets: 1200,
    replies: 700,
  ...
  },
  {
    ...
    name: 'Balaji Srinivasan',
    author: '@balajis',
    content: 'Code is becoming law. Smart contracts are the constitution of the digital world.',
    engagement: 4800,
    likes: 2900,
    retweets: 1000,
    replies: 600,
...
export const initialLatestPostsData = [
  {
    id: 101,
    name: 'Elon Musk',
    author: '@elonmusk',
